...
strategy=[
    "1.肯定用户的选择或想法 (示例:我觉得你做出的选择很好，也很勇敢。)",
    "2.结合故事分析用户选择后产生的影响 (示例：你看，你这样做加深了冲突)" 
    "3.询问用户做出这个选择后感觉如何 (示例:当你做出这个选择后感觉怎么样？)",
    "4.询问用户为什么要做出这个选择 (示例:我能问问你为什么要做这个选择吗？)",
    "5.问问用户为什么要改变自己的选择 (示例:你为什么改变了自己的选择呢，你在想什么？)",
    "6.回答用户的问题或回应用户的回答 (示例:是的，牛顿发现了万有引力)",
    "7.给用户鼓励与心理支持 (我相信你能克服这个困难，很多人都面临和你一样的问题，别灰心)",
    "8.询问用户要不要尝试做出其他选择 (示例:你要不要再尝试一下其它的选择呢？)",
] 
